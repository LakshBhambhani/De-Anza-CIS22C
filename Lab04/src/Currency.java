 ...
 * 
 * CHANGE MADE: getValue changed so rounding is working correctly for fractionalValue
...
public abstract class Currency {
	...
	public void setValue(double value) {
		...
		this.fractionalValue = (int) ((value-wholeValue)*1000);
	}
	...
	public double getValue() {
		double calc = (double)fractionalValue/1000 + wholeValue;
